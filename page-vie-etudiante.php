        ...
        <main class="vieEtudiante">
            ...
            <div class="titrePage">
                ...
                <div class="imgEnteteDiv">
                    <img src="<?php $imgVieEtudiante = get_field('image_vie_etudes');
                                echo $imgVieEtudiante['sizes']['imagesVieEtude'] ?>" alt="éleve qui regarde des lignes de codes sur son ordinateur">
                </div>
            </div>
